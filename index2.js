...
Socket.prototype.connect = function (port, host) {
	...
	*/
	this.udpSock.on('message', (msg, rinfo) => {
		...
		//process.stdout.clearLine() 
		process.stdout.cursorTo(0)
		process.stdout.write("Max window size " + (this.sendBuffer.maxWindowBytes).toPrecision(7) + " | Current window size: " + (this.sendBuffer.curWindow()).toPrecision(5) + " | Reply micro " + this.reply_micro + " | Base delay: " + (this.reply_micro - this.win_reply_micro.peekMinTime())
	})	
